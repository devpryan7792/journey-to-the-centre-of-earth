...
import { useGLTF, Sparkles, SpotLight } from '@react-three/drei';
...
export function Library() {
  ...
  // Load book model
  const { scene: bookScene } = useGLTF('/models/old_magical_book.glb');
...
useGLTF.preload('/models/old_magical_book.glb');
